...
function downloadResult()
{
	...
	var calc_url = window.location.href;
		...
		var param = "?loanamount="+loanamount+"&interest="+interest+"&period="+period;
		param += "&emi="+emi+"&totalinterest="+totalinterest+"&totalamount="+totalamount+"&url="+calc_url;
		
		var url = '/tools-and-calculators/downloadEMICalcResult'+param;
		window.location = url;
...
function renderChart(amount,total_interest)
{
	...
	$('#emipiechart').highcharts({
		colors: ['#27A840', '#F9A003', '#596157', '#cfd186', '#24CBE5', '#64E572', 
	      ...
	      <div class="container pt-150 pb-10">
	        ...
	        <div class="section-content">
	          <div class="row text-center">
	            <div class="col-md-12">
	              <h2 class="title title_header text-dark">	Home Loan EMI Calculator</h2>
	              <ol class="breadcrumb  text-black mt-10">
	                ...
	                <li class="active  title_header">Home Loan EMI Calculator</li>
	              </ol>
	            </div>
	          </div>
	        </div>
        ...
        <section class="section bg-lighter mb-2">
            <div class="container">
             <!--<div class="row text-right">
				<div class="col-sm-12">
					<button style="margin-bottom:20px;" type="submit" class="btn text-white btn-lg btn-flat btn-theme-colored2" onclick="downloadResult()" data-loading-text="Please wait..." fdprocessedid="6g1so">Download</button>
				</div>
			</div>-->
                        ...
                        <div class="row calculator">
                            <div class="col-sm-12 my-3">
                                <div class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                    ...
                                    <p class="m-0">
                                    	<input type="text" class="form-control" value="2500000" id="loanamount" class="number" maxlength="10" onchange="loanAmountChange()" />
                                    </p>
                                    <p class="m-0">
                                    	<div id="pricipal_slider" style="margin:0px;width:100%;"></div>
                            ...
                            <div class="col-sm-12 my-3">
                                <div class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                    ...
                                    <p class="m-0">
                                    	<input type="text" class="form-control" value="12.5" id="loaninterest" maxlength="4" onchange="loanInterestChange()" />
                                    </p>
                                    <p class="m-0">
                             ...
                             <div class="col-sm-12 my-3">
                                <div class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                    ...
                                    <p class="m-0">
                                    	<input type="text" class="form-control" value="20" id="loanterm" maxlength="4" onchange="loanTermChange()" />
                                    </p>
                                    <p class="m-1">
                                    	<div id="tenurechoice">
											<input type="radio" name="term" value="year" id="loanyears" onchange="termChange()" checked><label style="font-size:14px;"><strong>&nbsp;Years</strong></label>
											&nbsp;<input type="radio" name="term" value="month" id="loanmonths" onchange="termChange()" ><label style="font-size:14px;"><strong>&nbsp;Months</strong></label>
										</div>
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush">
                                        <li class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                            <div class="row">
                                                <span class="h6">Monthly Payment (EMI)</span>
                                            	<p class="text-muted text-sm mt-0 mb-0  d-lg-block">&#8377; <span class="text-theme-primary" id="res_emi"></span></p>
                                            </div>
                                        </li>
                                       <li class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                            <div class="row">
                                                <span class="h6">Total Interest Payable</span>
                                        ...
                                        <li class="service-box icon-box iconbox-theme-colored bg-white p-30 mb-10 border-1px">
                                            <div class="row">
                                                <span class="h6">Total Payment (Principal + Interest)</span>
