...
function showSummary()
{
	...
	}else
	{
		...
		if(folio_array.length == 0)
		{
			remaining_goal_amount = parseInt(target_amount);
			remaining_sip_amount = parseInt(sip_amount);
			str += '<tr class="goal_ques" style="font-weight: bold;"><td style="font-weight: bold;">Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" style="font-weight: bold;" value="'+numbersWithComma(sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg"></td></tr>';
		...
		}else
		{
			...
			}else
			{
				...
				str += '<tr class="goal_ques" style="font-weight: bold;"><td>Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" style="font-weight: bold;" value="'+numbersWithComma(remaining_sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg" ></td></tr>';
			}		
			$('#existing_summary_inner_div').append(str);
		}
	}
...
function showRecommendedFunds()
{
	...
	html += '<table id = "emergencytable" style="width:100%">';
	html += '<thead>';
	html += '<tr>';
		    ...
		    /* 	html += '<div class="scheme_details_div" style="border-bottom: 1px solid #ddd;padding: 10px 0px;">';
		    	 ...
		    	 *///if(i == 0)
		    	{
						...
						}else if(category == "Hybrid: Conservative")
			        {
		    			...
		    			var percent = numbersWithComma(((parseFloat(value1) * 100) / parseFloat(goal_based_amount)).toFixed(2));
		    			html += '<td class="tabletextleft" style="text-align: center !important;">'+ percent +'</td>';
						html += '<td class="tabletextleft" style="text-align: right;"><span id="txt_allocation_amount_'+loop_count+'">'+ numbersWithComma(value1.toFixed(0)) + '</span></td>';
...
function checkLoginDetails()
{
	...
	$.post("/clientValidateLogin", {txt_pan : ""+pan+"", txt_pass : ""+pass+""}, function(data)
    {
		...
		function(){
			top.location = "/goal/emergency?amount="+amount+"&inflation="+inflation+"&age="+age+"&goal_name="+goal_name;
		});
		return;
...
function txtamount()
{
    ...
    <section class="page-title page-title-layout5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Emergency</h1>
            <nav>
...
<p>You are <input id="txt_current_age" maxlength="2" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius" style="width:8%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text"> 
 years old now and your average monthly expenses are &nbsp;<i class="fa fa-inr"></i> 
<input id="txt_amount" maxlength="13" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius number" style="width:17%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text" onchange="addCommas()" onkeydown="txtamount()">.</p> 
</div>
</div>
</div>
</div>
...
<input id="txt_inflation" maxlength="5" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius" style="width:5%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text"  oninput="checkLengthinflation()">
 % and You would like to name this goal as  
<input id="txt_goal_name" maxlength="25" class="form-control form-control-sm w-15 w-custom-56 roboInput" style="width:20%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text"></p>
</div>
</div>
</div>
</div>
...
<button class="btn btn__secondary btn__rounded btnCol" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Emergency Goal</button>
</div>
</div>
</div>
</div>
...
<div class="row">
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p class="goalcontentbg">Your Targeted Emergency Fund<br>(in today's value)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			<h6><i class="fa fa-inr" aria-hidden="true"></i> <span id="span_invest_future_cost"></span></h6>
			<p class="goalcontentbg">Your Targeted Emergency Fund<br>(adjusting for <span class="span_inflation"></span>% inflation)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			...
			<p class="goalcontentbg" style="font-weight: bold;">Monthly SIP Investment<br>Required</p>
			<p></p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
...
<td class="border-top-0" style="font-weight: bold;"> <input type="text" class="form-control form-control-sm fundNamebg" style="font-weight: bold;" value="" id="txt_goal_amount" disabled="disabled"></td>
</tr>
<tr>
<td style="font-weight: bold;">Number of years you need to save </td>
<td style="font-weight: bold;"><input type="text" class="form-control form-control-sm fundNamebg" style="font-weight: bold;" value="" id="txt_goal_years" disabled="disabled"></td>
</tr>
<tr class="goal_ques" >
...
<div id="old_robo3" class="col-md-2" style="border-left: 1px solid #eee;">
</div>
</div>
</div>
