...
function showSummary()
{
	...
	}else
	{
		...
		if(folio_array.length == 0)
		{
			remaining_goal_amount = parseInt(target_amount);
			remaining_sip_amount = parseInt(sip_amount);
			str += '<tr class="goal_ques"><td style="font-weight: bold;">Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" value="'+numbersWithComma(sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg" style="font-weight: bold;"></td></tr>';
...
function showRecommendedFunds()
{
	...
	html += '<table id="dreamhometable" style="width:100%;">';
	html += '<thead>';
	html += '<tr>';
...
function saveGoal(goal_type)
{
	...
	{ */
		 var table = document.getElementById('dreamhometable');
...
function checkLoginDetails()
{
	...
	$.post("/clientValidateLogin", {txt_pan : ""+pan+"", txt_pass : ""+pass+""}, function(data)
    {
		...
		function(){
			top.location = "/goal/home?amount="+amount+"&horizon="+horizon+"&inflation="+inflation+"&risk="+risk+"&goal_name="+goal_name;
		});
		return;
...
function returnFilter(retrunType) {
    ...
    <section class="page-title page-title-layout5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Dream home</h1>
            <nav>
              <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item"><a href="/tools-and-calculators/become-a-crorepati">Goals</a></li>
                <li class="breadcrumb-item active" aria-current="page">Dream home</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
    ...
    <section class="team-layout1 pb-20">
      <div class="container">
		...
		<div class="title-v1">
			<h1 class="text-center">Dream Home</h1>
		</div>
		</div>
		</div>
		...
		<p>You are planning to buy your Dream House  
		<input id="txt_years" maxlength="2" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius" style="width:10%;color: #529100;font-weight: bold;font-size: 16px !important;"  value="" type="text" onkeydown="txtyears()">
		years.</p> 
		</div>
		</div>
		</div>
		...
		<input id="txt_amount" maxlength="13" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius number" style="width:17%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text" onchange="addCommas()" onkeydown="addCommas()">
		in today's value.</p>
		</div>
		</div>
		</div>
		...
		<input id="txt_inflation" maxlength="5" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius" style="width:8%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="number" oninput="checkLengthinflation()">
		 % and You would like to name this goal as  
		<input id="txt_goal_name" maxlength="25" class="form-control form-control-sm w-15 w-custom-56 roboInput" style="width:20%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text" onkeydown="txtgoalName()" ></p>
		</div>
		</div>
		</div>
		</div>
		 
		<div class="row pt4 childp3 pdesign" style="display: none !important;">
		<div class="col-md-12 form-inline">
		<div class="row" style="margin:0px;margin-bottom:3%">
		<div class="col-md-12" style="float:none;margin:0 auto;">
		<p>You can take 
		<select id="sel_risk" class="form-control form-control-sm w-25 w-custom-50 roboInput textInputRadius" onchange="riskProfileChange()" style="text-align:center;text-align-last:center;width:23%;padding:0px; color: #172460; font-weight: bold; font-size: 16px !important;">
		...
		<button class="btn btn__secondary btn__rounded btnCol" style="margin:0 auto; float: none;" onclick="checkResult()">Build My Dream Home Goal</button>
		</div>
		</div> 
		</div>
		</div>
			 ...
			 <div class="row text-center">	  
			  ...
			  <div class="row">
			   <div class="col-md-12 col-sm-12 pt-4">	   
				 ...
				 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="goToStep1()">Back</button>
				    ...
				    <div class="row">
					 ...
					 <div class="row py-4">
						 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
							 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="hide_div(2)">Back</button>
			  	...
			  	<div class="row">
			   		<div class="col-lg-12 pt-4">
				    	...
				    	<div class="row">
						 ...
						 <div class="row py-4">
							 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
								 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="hide_div(3)">Back</button>
			   		...
			   		<div class="col-lg-12 pt-4">
			    		<div class="row">
				    		...
				    		<div class="row">
							 ...
							 <div class="row py-4">
								  <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
									 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="hide_div(4)">Back</button>
			  	...
			  	<div class="row">
			   		<div class="col-lg-12 pt-4">
			    		<div class="row">
						 ...
						 <div class="row py-4">
							 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
								 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="hide_div(5)">Back</button>
			  	...
			  	<div class="row">
			   		<div class="col-lg-12 pt-4">
				    	...
				    	<div class="row">
						 ...
						 <div class="row py-4">
							 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
								 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" onclick="hide_div(6)">Back</button>
		...
		<td style="font-weight: bold;"><input type="text"  class="form-control form-control-sm fundNamebg" style="font-weight: bold;"  value=" " id="txt_goal_sip_amount"></td>
		</tr>
		</tbody>
		</table>
		</div>
		...
		<div class="col-lg-12 text-center">
		<button class="btn btn-primary" style="width: auto; background-color: #20C4B7   ;border-color: #6ac259;color: #080808;  font-weight: bold;color: #080808;" onclick="goToStep2()">Back</button>
		<c:choose>
		<c:when test="${accountMap != null}">
		...
		<div class="row mb-30" id="recommended_div">
		<div class="col-lg-12 text-right">
		...
		<c:when test="${accountMap != null}">
			...
			<button class="btn btn-block btnfloat" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808; " onclick="goToStep3()">Back</button>	
			<!-- </div> -->
			<!-- </div> -->
		</c:when>
		<c:otherwise>
...
<div id="scheme_name_change_model" class="modal modalscroll fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-lg modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content modal-dialog-scrollable">
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-primary" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #fff;  font-weight: bold;color: #080808;" data-dismiss="modal">Close</button>
...
<div id="login_model" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered" style="max-width:500px !important;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<button type="button" class="btn btn-primary" style="width: auto; background-color: #20C4B7;border-color: #6ac259;color: #080808;  font-weight: bold;color: #080808;" data-dismiss="modal">Close</button>
