...
$(document).ready(function(){
	 ...
	 $('#tdreturn1').addClass('displaytd');
	 $('#tdreturn1').removeClass('undisplaytd');
	 $('#tdreturn3').removeClass('displaytd');
	 $('#tdreturn3').addClass('undisplaytd');
	 $('#tdreturn5').removeClass('displaytd');
	 $('#tdreturn5').addClass('undisplaytd');
	  ...
	  $('.txtinflationcheckfloat').keypress(function(event) {
...
function showSummary()
{
	...
	}else
	{
		...
		if(folio_array.length == 0)
		{
			remaining_goal_amount = parseInt(target_amount);
			remaining_sip_amount = parseInt(sip_amount);
			str += '<tr class="goal_ques"><td style = "font-weight : bold !important;">Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" value="'+numbersWithComma(sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg" style = "font-weight : bold !important;"></td></tr>';
		...
		}else
		{
			...
			}else
			{
				...
				str += '<tr class="goal_ques"><td style = "font-weight : bold !important;">Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" value="'+numbersWithComma(remaining_sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg" style = "font-weight : bold !important;" ></td></tr>';
			}		
			$('#existing_summary_inner_div').append(str);
		}
	}
...
function schemeChange(id, category, scheme_code)
{
	...
	$.post("/goal/getFundRatingBasedSchemes", {category : category, scheme_code : scheme_code, max_count : 4}, function(data)
    {
		...
		$('#scheme_name_change_model').appendTo("body") 
...
function showRecommendedFunds()
{
	...
	html += '<table id="savegoaltable" style="width:100%;">';
	html += '<thead>';
	html += '<tr>';
	...
	for(k=0;k<cat_rolling_array.length;k++)
    {
		...
		$.post("/goal/getFundRatingBasedSchemes", {category : category, max_count : max_count}, function(data)
	    {
			...
			childeducationcount = schemePerformances_array.length;
		    ...
		    /* 	html += '<div class="scheme_details_div" style="border-bottom: 1px solid #ddd;padding: 20px 0px;">';
		    	html += '<input type="hidden" class="count_id" value="'+loop_count+'" />';
		    	html += '<h4 style="font-size: 14px;color: #333; margin: 0 0 0 0;" id="span_scheme_h4_'+loop_count+'"><span id="span_scheme_'+loop_count+'">' + scheme_name + '</span></h4>';
...
function saveGoal(goal_type)
{
	...
	{		 
		*/
		var table = document.getElementById('savegoaltable');
...
function returnFilter(retrunType) {
    ...
    /* $('.yearsfilter').find('a').removeClass('active');
    $('.returnsper').hide();
    $('.return1,.return3,.return5').hide();
    $('.' + retrunType).show();
    $('#' + retrunType).addClass('active');
    $('.returnTh').attr('id', 'th' + retrunType); */
  }
  
function showExistingFunds()
{
	showFunds();
}
    ...
    <section class="page-title page-title-layout5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Child's Education</h1>
            <nav>
              <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item"><a href="/tools-and-calculators/become-a-crorepati">Goals</a></li>
                <li class="breadcrumb-item active" aria-current="page">Child's Education</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
...
<div class="title-v1">
	<h1 class="text-center">Child's Education</h1>
</div>
</div>
</div>
...
<p>You are planning for your Child's Higher Education which is   
<input id="txt_years" maxlength="2" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius fontcolorsize" style="width: 10%;color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text" onkeydown="txtyears()">
years away.</p> 
</div>
</div>
</div>
...
<div class="row" style="margin:0px;margin-bottom:3%">
<div class="col-md-12" style="float:none;margin:0 auto;">
<p>The cost of which would be around &nbsp;<i class="fa fa-inr"></i> 
<input id="txt_amount" maxlength="13" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius number fontcolorsize" style="color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text" onchange="addCommas()" onkeydown="addCommas()">
in today's value.</p>
</div>
</div>
</div>
...
<input id="txt_inflation" maxlength="5" class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius pdesign" style="color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="number" onkeydown="txtgoalName()" oninput="checkLengthinflation()" >
 % and You can take 
<select id="sel_risk" class="form-control form-control-sm w-25 w-custom-50 roboInput textInputRadius selrisk" onchange="riskProfileChange()" style="text-align:center;text-align-last:center;width:23%;padding:0px; font-size: 16px !important;">
...
<div class="row pt4 childp3 pdesign" style="margin:0px; display: none !important;">	  
<div class="col-md-12 form-inline" style="float:none;margin:0 auto;">
<p>You would like to name this goal as  
<input id="txt_goal_name" maxlength="25" class="form-control form-control-sm w-15 w-custom-56 roboInput fontcolorsize" style="color: #529100;font-weight: bold;font-size: 16px !important;" value="" type="text"  >
</p>
</div>
</div>

<div class="row pt4" style="margin-top: -21px !important;">
<div class="col-md-12 text-center pb-5">	
<button class="btn btn-primary btn-lg btnCol" style="margin:0 auto; float: none; margin-top: 5% !important " onclick="checkResult()">Build My Child's Education Goal</button>
</div>
</div>
	 ...
	 <div class="row text-center">	  
	  ...
	  <div class="row">
	   <div class="col-md-12 col-sm-12 pt-4">	   
		 ...
		 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="goToStep1()">Back</button>
  	...
  	<div class="row">
		<div class="col-lg-12 pt-4">
		    ...
		    <div class="row">
			 ...
			 <div class="row py-4">
				 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
					 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="hide_div(2)">Back</button>
	  	...
	  	<div class="row">
	   		<div class="col-lg-12 pt-4">
		    	...
		    	<div class="row">
				 ...
				 <div class="row py-4">
					 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
						 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="hide_div(3)">Back</button>
	   		...
	   		<div class="col-lg-12 pt-4">
	    		<div class="row">
		    		...
		    		<div class="row">
					 ...
					 <div class="row py-4">
						  <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
							 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="hide_div(4)">Back</button>
	  	...
	  	<div class="row">
	   		<div class="col-lg-12 pt-4">
	    		<div class="row">
				 ...
				 <div class="row py-4">
					 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
						 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="hide_div(5)">Back</button>
	  	...
	  	<div class="row">
	   		<div class="col-lg-12 pt-4">
		    	...
		    	<div class="row">
				 ...
				 <div class="row py-4">
					 <div class="col-lg-12 text-center pb-4" style=" margin-top: 5% !important;">
						 <button class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom" style="background-color: #6ac259;border-color: #6ac259;color: #080808;  font-weight: bold;" onclick="hide_div(6)">Back</button>
...
<div class="row">
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			<h6><i class="fa fa-inr" aria-hidden="true"></i> <span id="span_invest_today_cost" style="font-size: 141% !important;"></span></h6>
			<p class ="goalcontentbg">Your Targeted Amount<br>(in today's value)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			<h6><i class="fa fa-inr" aria-hidden="true"></i> <span id="span_invest_future_cost" style="font-size: 141% !important;"></span></h6>
			<p class ="goalcontentbg">Future Value of Higher Education<br>(adjusting for <span class="span_inflation"></span>% inflation)</p>
		</div>
	</div>
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
		
			<h6><span id="span_no_years" style="font-size: 141% !important;"></span></h6>
	...
	<div class="col-lg-6 col-sm-4 text-center mb-3">
		<div class="box bg-tf p-3">
			<h6><i class="fa fa-inr" aria-hidden="true"></i> <span id="span_sip_amt" style="font-size: 141% !important;"></span></h6>
...
<td class="border-top-0"> <input type="text" class="form-control form-control-sm fundNamebg" style="font-weight : bold !important;" value="" id="txt_goal_amount" disabled="disabled"></td>
</tr>
<tr>
<td style="font-weight: bold;">Number of years you need to save </td>
<td ><input type="text" class="form-control form-control-sm fundNamebg"  style="font-weight : bold !important;" value="" id="txt_goal_years" disabled="disabled"></td>
</tr>
<tr class="goal_ques">
<td style="font-weight: bold;">Monthly SIP investment required</td>
<td ><input type="text" class="form-control form-control-sm fundNamebg " style="font-weight : bold !important;" value=" " id="txt_goal_sip_amount"></td>
</tr>
</tbody>
</table>
</div>
...
<div id="goal_pie_chart" class="clear" style="height: 250px;"></div>
...
<div id="scheme_name_change_model" class="modal fade modalscroll" tabindex="-1" data-backdrop="static" data-keyboard="false">
  <div class="modal-lg modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content modal-dialog-scrollable">
      <div class="modal-header" style="background: #6ac259;color: white;">
          	<div class="col-md-10">
          		<h4 class="modal-title" style="color: white;">Change the Scheme Name</h4>
          	</div>
      </div>
