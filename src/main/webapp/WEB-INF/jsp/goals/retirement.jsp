...
$(document).ready(function(){
	...
	if(currentAge != "")
	{
		...
		$("#txt_corpus_return").val(corpus_return);
		$("#sel_risk").val(risk);
...
function retirementCalc()
{
	...
	corpus_return = $("#txt_corpus_return").val();
	risk = $("#sel_risk").val();
	...
	var future_value_amount = Math.round(FV1);
	...
	//alert("monthly_savings--->"+monthly_savings);
...
function retirementCalc2()
{
	current_age = $("#txt_current_age1").val();
	retire_age = $("#txt_retire_age1").val();
	life_age = $("#txt_life_age1").val();
	amount = $("#txt_amount1").val();
	savings_amount = $("#txt_savings_amount1").val();
	inflation = $("#txt_inflation1").val();
	corpus_return = $("#txt_corpus_return1").val();
	...
	}else
	{
		...
		}else
		{
			...
			}else
			{
				...
				str += '<tr class="goal_ques"><td style="font-weight: bold;">Monthly SIP investment required</td><td><input type="text" id="txt_goal_sip_amount" style="font-weight: bold;" value="'+numbersWithComma(remaining_sip_amount.toFixed(0))+'" class="form-control form-control-sm fundNamebg" ></td></tr>';
			}		
			$('#existing_summary_inner_div').append(str);
		}
	}
...
function calculateDebtAndEquity()
{
	if(existing_portfolio_flag)
	{
		...
		$("#txt_current_age1").val(current_age);
		$("#txt_retire_age1").val(retire_age);
		$("#txt_life_age1").val(life_age);
		$("#txt_amount1").val(numbersWithComma(amount));
		$("#txt_savings_amount1").val(numbersWithComma(savings_amount));
		$("#txt_inflation1").val(inflation);
		$("#txt_corpus_return1").val(corpus_return);
	...
	}else
	{
		...
		$('#old_robo1').addClass('col-md-12');
		$('#old_robo2').removeClass('col-md-3');
		$('#old_robo2').addClass('col-md-3');
...
function showRecommendedFunds()
{
	...
	if(long_term_debt > 0)
	{
		cat_rolling_array.push("Debt: Banking and PSU");	
	}
	if(hybrid_debt > 0)
	{
	...
	html += '<table id="retirementtable" style="width:100%;">';
	html += '<thead>';
	html += '<tr>';
	...
	for(k=0;k<cat_rolling_array.length;k++)
    {
		...
		if(category == "Debt: Banking and PSU")
		{
		...
		$.post("/goal/getFundRatingBasedSchemes", {category : category, max_count : max_count}, function(data)
	    {
		    ...
		    /* 	html += '<div class="scheme_details_div" style="border-bottom: 1px solid #ddd;padding: 10px 0px;">';
			    ...
			    }else if(category == "Debt: Banking and PSU")
			        {
...
function addCommas2() 
{
	...
	if(otherNumbers != '')
	    lastThree = ',' + lastThree;
	var res = otherNumbers.replace(/\B(?=(\d{2})+(?!\d))/g, ",") + lastThree + afterPoint;
	$("#txt_savings_amount").val(res);
}
function addCommas4() 
{
	var x = $("#txt_savings_amount1").val();
	x = x.toString();
	x = x.replace(/,/g,'');
	var afterPoint = '';
	if(x.indexOf('.') > 0)
...
function saveGoal(goal_type)
{
	...
	{ */
		  var table = document.getElementById('retirementtable');
	...
	$.post("/goal/saveGoal", {target_goal : "" + target_goal + "",goal_name : "" + goal_name + "",amount : "" + amount + "",
		...
		existing_scheme_code : "" + existing_scheme_code_str + "",existing_scheme_sip : "" + existing_scheme_sip_str + "",
		existing_scheme_current_value : "" + existing_scheme_current_value_str + "",current_age : "" + current_age + "",retire_age : "" + retire_age + "",life_age : "" + life_age + ""}, function(data)
    {
			$.LoadingOverlay("hide");
...
function txtsavingsamount()
{
    ...
    <section class="page-title page-title-layout5">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="pagetitle__heading">Retirement</h1>
            <nav>
      ...
      <div class="container">
			...
			<div class="robo1 ques_1">
				...
				<div class="row" style="margin-top: 30px;">
					...
					<div class="col-md-12 col-sm-12"
							...
							<div class="col-md-12 form-inline">
								<div class="row" style="margin: 0px; margin-bottom: 3%;">
									<div class="col-md-12" style="float: none; margin: 0 auto;">
										<p>
											You are <input id="txt_current_age" maxlength="2"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius"
												style="width: 5%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text"> years old and want to retire
											at age <input id="txt_retire_age" maxlength="2"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius"
												style="width: 5%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text"> years and your life expectancy
											is <input id="txt_life_age" maxlength="2"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius"
												style="width: 5%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text" onkeydown="txtlifeage()">
											years.
										</p>
									</div>
								</div>
						...
						<div class="row pt4 childp1 pdesign"
							style="display: none !important;">
							<div class="col-md-12 form-inline">
								<div class="row" style="margin: 0px; margin-bottom: 3%">
									<div class="col-md-12" style="float: none; margin: 0 auto;">
										<p>
											Your current monthly household expenses is &nbsp;<i
												class="fa fa-inr"></i> <input id="txt_amount" maxlength="13"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius number"
												style="width: 17%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text" onchange="addCommas()">. You
											assume the inflation to be <input id="txt_inflation"
												maxlength="2"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius"
												style="width: 5%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text" onkeydown="txtinflation()"> %
											and
										</p>
						...
						<div class="row pt4 childp2 pdesign"
							style="display: none !important;">
							<div class="col-md-12 form-inline">
								<div class="row" style="margin: 0px; margin-bottom: 3%">
									<div class="col-md-12" style="float: none; margin: 0 auto;">
										<p>
											expect <input id="txt_corpus_return" maxlength="2"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius"
												style="width: 5%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text"> % earning on retirement
											corpus. You have already saved &nbsp;<i class="fa fa-inr"></i>
											<input id="txt_savings_amount" maxlength="13"
												class="form-control form-control-sm w-15 w-custom-56 roboInput textInputRadius number"
												style="width: 17%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text" onchange="addCommas2()"
												onkeydown="txtsavingsamount()"> for your Retirement.
										</p>
									</div>
								</div>
							</div>
						...
						<div class="row pt4 childp3 pdesign"
							style="display: none !important;">
							<div class="col-md-12 form-inline">
								<div class="row" style="margin: 0px; margin-bottom: 3%">
									<div class="col-md-12" style="float: none; margin: 0 auto;">
										<p>
											You would like to name this goal as <input id="txt_goal_name"
												maxlength="25"
												class="form-control form-control-sm w-15 w-custom-56 roboInput"
												style="width: 20%; color: #529100; font-weight: bold; font-size: 16px !important;"
												value="" type="text">. You can take <select
												id="sel_risk"
												class="form-control form-control-sm w-25 w-custom-50 roboInput textInputRadius"
												onchange="riskProfileChange()"
												style="text-align: center; text-align-last: center; width: 23%; padding: 0px; color: #172460; font-weight: bold; font-size: 16px !important;">
											...
											</select> risk with your investments
										</p>
									</div>
								</div>
							</div>
						</div>
						<div class="row pt4" style="margin-top: 0px !important;">
							<div class="col-md-12 text-center pb-5">
								<button class="btn btn__secondary btn__rounded btnCol"
									style="margin: 0 auto; float: none;" onclick="retirementCalc()">Build
									My Retirement Goal</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="robo2">
						...
						<div class="col-md-12 col-sm-12"
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									...
									<p class="textColor font-size-19 question">Describe your
							...
							<div class="row">
								<div class="col-md-6"
									style="margin: 0 auto; display: grid; float: none;">
							...
							<div class=" row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										...
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
				...
				<div class="container calc_div1" id="step2">
					...
					<div class="row">
						<div class="col-lg-12" style="padding-top: 0.5rem !important;">
							<div class="row">
								<div class="col-lg-12 text-center">
									<h4 class="text-dark">Step 2:</h4>
									<p class="textColor font-size-19 question">When you invest
							...
							<div class="row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom"
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
										onclick="hide_div(2)">Back</button>
									<button
										class="btn btn-success col-lg-custom  btn-md btnCol ml-2"
						...
						<div class="col-lg-12" style="padding-top: 0.5rem !important;">
							<div class="row">
								<div class="col-lg-12 text-center">
									...
									<p class="textColor font-size-19 question">
							...
							<div class="row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom"
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
										onclick="hide_div(3)">Back</button>
									<button
										class="btn btn-success col-lg-custom  btn-md btnCol ml-2"
						...
						<div class="col-lg-12" style="padding-top: 0.5rem !important;">
							<div class="row">
								<div class="col-lg-12 text-center">
									...
									<p class="textColor font-size-19 question">Have you ever
							...
							<div class="row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom"
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
										onclick="hide_div(4)">Back</button>
									<button
										class="btn btn-success col-lg-custom  btn-md btnCol ml-2"
							...
							<div class="row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom"
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
										onclick="hide_div(5)">Back</button>
									<button
										class="btn btn-success col-lg-custom  btn-md btnCol ml-2"
						...
						<div class="col-lg-12" style="padding-top: 0.5rem !important;">
							<div class="row">
								<div class="col-lg-12 text-center">
									...
									<p class="textColor font-size-19 question">How do you react
							...
							<div class="row py-4">
								<div class="col-lg-12 text-center pb-4"
									...
									<button
										class="btn btn-primary col-lg-custom btn-md btnCol col-lg-border-custom"
										style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;"
										onclick="hide_div(6)">Back</button>
									<button
										class="btn btn-success col-lg-custom  btn-md btnCol ml-2"
								...
								<div class="col-lg-12">
									<div style="display: inline-block; width: 92%;">
										<div class="text-center" style="padding-bottom: 3%;">
											<h1 style="color: #28395E;">Goal Summary</h1>
										</div>
									</div>
									<div style="display: inline-block;">
										<div class="text-right">
											<a href="javascript:void(0)" onclick="goToStep1()"> <i
												class="fa fa-arrow-circle-o-left" aria-hidden="true"
												style="width: 50px; font-size: 38px; color: #003399;"></i> <!-- <img src="resources/img/back_img.png" alt="" style="width:40px;" /> -->
											</a>
										</div>
									</div>
								</div>
							...
							<div class="row">
									...
									<div class="box bg-tf p-3">
										<h6>
											<i class="fa fa-inr" aria-hidden="true"></i> <span
												id="span_invest_today_cost"></span>
										</h6>
										<p class="goalcontentbg">
											Your Current Monthly household Expenses<br>(in today's
											value)
										</p>
									</div>
								</div>
								<div class="col-lg-6 col-sm-4 text-center mb-3">
									<div class="box bg-tf p-3">
										<h6>
											<i class="fa fa-inr" aria-hidden="true"></i> <span
												id="span_invest_future_cost"></span>
										</h6>
										<p class="goalcontentbg">
											Retirement Corpus Amount<br>(adjusting for <span
												class="span_inflation"></span>% inflation)
										</p>
									</div>
								</div>
								<div class="col-lg-6 col-sm-4 text-center mb-3">
									<div class="box bg-tf p-3">
										<h6>
											<span id="span_current_savings"></span>
										</h6>
										<p class="goalcontentbg">Your Current Savings Now</p>
										<p></p>
									</div>
								</div>
								<div class="col-lg-6 col-sm-4 text-center mb-3">
									<div class="box bg-tf p-3">
										<h6>
											<span id="span_future_savings"></span>
										</h6>
										<p class="goalcontentbg">Future Value of your current
											Savings</p>
										<p></p>
									</div>
								</div>
										...
										<c:when test="${accountMap != null}">
											<a href="javascript:void(0)" onclick="showFunds()">
												<div class="box bg-tf p-3 Truuegro3">
													...
													<p
														style="font-size: 12px; line-height: 15px; margin-top: 10px;">If
														yes, please click here and map your existing investments
														to this goal</p>
												</div>
											</a>
										</c:when>
								...
								<div class="col-lg-6 col-sm-4 text-center mb-3">
									<a href="javascript:void(0)" onclick="calculateDebtAndEquity()">
										<div class="box bg-tf p-3 Truuegro2">
											<p class="Truuegro_bold">No, I do not have investments with
												you</p>
											<p
												style="font-size: 12px; line-height: 15px; margin-top: 10px;">Take
												me to the plan without mapping any <br/>existing investments</p>
										</div>
									</a>
								</div>
							</div>
					...
					<div class="col-lg-10 pt-4 offset-lg-1">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-sm-4 text-center mb-3">
								<div class="box bg-tf p-3">
									<h6>
										<i class="fa fa-inr" aria-hidden="true"></i> <span
											id="span_scheme_cost">0</span>
									</h6>
									<p class="goalcontentbg">
										Total Future Value<br>(Scheme Selected Value)
									</p>
								</div>
							</div>
						</div>
						...
						<div class="existing_portfolio_div">
							...
							<div class="row existing_div">
								<div class="col-lg-12">
									<div class="table-responsive">
										<table class="table table-bordered body-color"
											id="tbl_existing_portfolio_returns"
											style="width: 100%; margin-bottom: 10px;"></table>
									</div>
									<p>If you wish to link any of the above schemes with this
										goal, then please check the relevant box/es as given alongside
										the scheme name.</p>
								</div>
							</div>
							...
							<div class="row pt-3 existing_div">
								<div class="col-lg-12 text-right">
									...
									<input type="hidden" value="${scheme_code_list}"
										id="txt_scheme_code_list" />
							...
							<div class="row pb-2 existing_summary_div">
								<div class="col-lg-12">
									...
									<table class="table" id="existing_summary_inner_div">
										<tbody>
											<tr>
												<td class="border-top-0" style="font-weight: bold;">Your
													targeted Amount (Inflation adjusted <span
													class="span_inflation">5</span>% per annum)
												</td>
												<td class="border-top-0"><input type="text"
													class="form-control form-control-sm fundNamebg"
													style="font-weight: bold;" value="" id="txt_goal_amount"
													disabled="disabled"></td>
											</tr>
											<tr>
												<td style="font-weight: bold;">Number of years you need
													to save</td>
												<td><input type="text"
													class="form-control form-control-sm fundNamebg"
													style="font-weight: bold;" value="" id="txt_goal_years"
													disabled="disabled"></td>
											</tr>
											<tr class="goal_ques">
												<td style="font-weight: bold;">Monthly SIP investment
													required</td>
												<td><input type="text"
													class="form-control form-control-sm fundNamebg"
													style="font-weight: bold;" value=" "
													id="txt_goal_sip_amount"></td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<div class="row pb-5 pt-3" id="save_goal_div">
							<div class="col-lg-12 text-center">
								...
								<c:choose>
									<c:when test="${accountMap != null}">
										<button class="btn btn-success ml-2" style="width: auto;"
											onclick="saveGoal(1)">Save Your Goal</button>
									</c:when>
									<c:otherwise>
										<button class="btn btn-success ml-2" style="width: auto;"
											onclick="showLogin(1)">Save Your Goal</button>
									</c:otherwise>
								</c:choose>
							</div>
						</div>
						...
						<div class="row pb-5 pt-3" id="recommended_div">
							<div class="col-lg-12 text-right">
								...
								<button class="btn btn-success ml-2"
									onclick="calculateDebtAndEquity()">Achieve your Goal
									on SIP</button>
							</div>
						</div>
								...
								<div class="row chartpagefirstrowcontent" style="margin: 0px;">
									<div id="old_robo7" class="col-md-3">
										<div class="box bg-tf"
											...
											<span class="value amtcolor"> <span>SIP</span>
											</span>
										</div>
									</div>
									<div id="old_robo8" class="col-md-2">
										<div class="box bg-tf"
											...
											<span class="value amtcolor"> <span id="spn_risk"></span>
											</span>
										</div>
									</div>
									<div id="old_robo6" class="col-md-2">
										<div class="box bg-tf"
											...
											<span class="value amtcolor"><span id="spn_years"></span>
											</span>
										</div>
									</div>
									<div id="old_robo4" class="col-md-2">
										<div class="box bg-tf"
											...
											<span class="value amtcolor"><i class="fa fa-inr"></i>
												<span id="spn_target_amount"></span> </span>
										</div>
									</div>
									<div id="old_robo5" class="col-md-3">
										<div class="box bg-tf"
											...
											<span class="value amtcolor"><i class="fa fa-inr"></i>
												<span id="spn_sip_amount"></span> </span>
										</div>
									</div>
								</div>
								<div class="row" style="margin-top: 30px;">
									<div id="old_robo2" class="col-md-3">
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div id="goal_pie_chart" class="clear"
									...
									<div id="old_robo2content" class="col-md-4 robo2design">
										<div class="result-box">
											...
											<div class="heading col-md-12"
												style="color: #0fc4f9; font-weight: bold;">Low Risk,
												Stable Return</div>
											<div class="content col-md-12"
												style="font-size: 12px !important;">This is a
												conservative portfolio meant to minimize the risk of losing
												principal by managing the asset allocation as 40% in equity
												funds and remaining 60% in hybrid funds. Those experienced
												as well as novice investors who want to play safe by taking
												low risk are an ideal suit for this.</div>
										</div>
									</div>
									<div id="old_robo2contentpage" class="col-md-3 bordercontent2">
										<div class="plan-box">
											...
											<ul class="planboxfeaturelist col-md-12 ulfontsize">
												<li><i class="fa fa-check-circle checkcolor"
													aria-hidden="true"></i> Zero Fee A/C - No Transaction
													Charges</li>
												<li><i class="fa fa-check-circle checkcolor"
													aria-hidden="true"></i> Top AMCs under One Roof</li>
												<li><i class="fa fa-check-circle checkcolor"
													aria-hidden="true"></i> Personalized Recommendation</li>
												<li><i class="fa fa-check-circle checkcolor"
													aria-hidden="true"></i> One Account to Manage Family
													Members</li>
												<li><i class="fa fa-check-circle checkcolor"
													aria-hidden="true"></i> Hassle Free &amp; Paperless
													Investment</li>
											</ul>
									...
									<div id="old_robo3">
										<ul
											class="planboxfeaturelist planboxfeaturelist2 oldrobo3 ulfontsize">
											<li><i class="fa fa-check-circle checkcolor"
												aria-hidden="true"></i> Active Support Desk</li>
											<li><i class="fa fa-check-circle checkcolor"
												aria-hidden="true"></i> Advanced Dashboard</li>
											<li><i class="fa fa-check-circle checkcolor"
												aria-hidden="true"></i> Refer and Earn</li>
											<li><i class="fa fa-check-circle checkcolor"
												aria-hidden="true"></i> Tax Planning</li>
											<li><i class="fa fa-check-circle checkcolor"
												aria-hidden="true"></i> Customized Portfolio</li>
										</ul>
										<!-- <div class="row">
...
<i class="fa fa-spinner fa-pulse fa-5x" aria-hidden="true"></i>
								...
								<div id="old_robo3" class="col-md-2"
								...
								<div class="col-lg-12 " style=" max-width: 97% !important;">
									<div class="process-payment">
										<div class="total_payment">
											<div class="title">
												Total Amount <span
													style="margin-left: 12px; font-size: 16px;"><i
													class="fa fa-inr"></i></span><span id="totAmt"
													style="color: #2e3e4f; margin-left: 6px; font-size: 20px; font-weight: bold;"></span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-12" style="max-width: 98% !important;">
									<c:choose>
										<c:when test="${accountMap != null}">
											...
											<button type="submit" class="btn btn-success btnfloat"
												style="width: auto;" onclick="saveGoal(2)">Save
												Your Goal</button>
											<!-- </div> -->
											<!-- <div class="col-lg-3"> -->
											<!-- <div style="margin-right:15px;"> -->
											<button class="btn btn-block btnfloat"
												style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold; color: #080808;"
												onclick="goToStep3()">Back</button>
											<!-- </div> -->
											<!-- </div> -->
										</c:when>
										<c:otherwise>
											...
											<button type="submit" class="btn btn-success btnfloat"
												onclick="showLogin(2)" style="max-width: auto;">Save
												Your Goal</button>
											<!-- </div>
	<div class="col-lg-3">
	<div style="margin-right:15px;" class="mr-0 mr-lg-3"> -->
											<button class="btn btn-block btnfloat" onclick="goToStep2()"
												style="width: auto; background-color: #20C4B7; border-color: #6ac259; color: #fff; font-weight: bold;">Back</button>
											<!-- </div>
	</div> -->
										</c:otherwise>
									</c:choose>
							...
							<div class="pt-3" style="padding-bottom: 30px;"></div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="modal-lg modal-dialog modal-dialog-centered">
		...
		<div class="modal-content">
			<div class="modal-header"
				style="background: #6ac259; font-weight: bold; color: white; font-size: 16px;">
				<div class="col-md-10">
...
<div id="login_model" class="modal fade" tabindex="-1"
	data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-dialog-centered"
		...
		<div class="modal-content">
			<div class="modal-header"
				style="background: #6ac259; font-weight: bold; color: white; font-size: 16px;">Login</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary"
					...
					data-dismiss="modal">Close</button>
				<button class="btn btn-success" type="submit"
					onclick="checkLoginDetails()">Login</button>
			</div>
		</div>
	</div>
</div>
