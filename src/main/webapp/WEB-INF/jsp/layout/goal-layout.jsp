...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="/img/favicon.png" type="image/png">
			...
			<c:when test="${page eq 'robo-advisor'}">
			<title>Goal-based Lumpsum Investment Robo Advisor | Meet Truuegro, Gurgaon</title>
			<meta name="description" content="You can invest in your future Goal by way of Mutual Fund Lumpsum Investment with the help of a Robo Advisor | Meet Truuegro, Gurgaon."/>
			</c:when>
			
			<c:when test="${page eq 'sip-robo-advisor'}">
			<title>Goal-based SIP Investment Robo Advisor | Meet Truuegro, Gurgaon</title>
			<meta name="description" content="You can invest in your future Goal by way of Mutual Fund SIPs with the help of a Robo Advisor | Meet Truuegro, Gurgaon."/>
			</c:when>	
			
			<c:when test="${page eq 'grow-money' || page eq 'retirement' || page eq 'emergency' || page eq 'home' || page eq 'child-education' || page eq 'child-wedding'}">
			<title>Create a financial goal with Robo Tools | Meet Truuegro, Gurgaon</title>
			<meta name="description" content="You can now create a financial goal with the help of our Robo Advisory Tools | Meet Truuegro, Gurgaon."/>
			</c:when>
			<c:otherwise>
